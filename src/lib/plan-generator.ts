...
قواعد الإخراج:
- الإخراج必须是 JSON صالح فقط — لا نص قبله أو بعده، لا أسوار markdown.
...
أهم النقاط:
- استخدم الرموز التعبيرية (📊 🥩 🥑 🌾 💊 🌙 🩸 💧 🍽️ 🌅) في overview و health_notes لتعزيز القراءة.
