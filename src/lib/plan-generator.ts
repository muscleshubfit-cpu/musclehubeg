...
const NUTRITION_SYSTEM_PROMPT = `أنت أخصائي تغذية رياضية محترف يعمل في منصة MuscleHub.
...
const WORKOUT_SYSTEM_PROMPT = `أنت مدرب لياقة محترف يعمل في منصة MuscleHub.
