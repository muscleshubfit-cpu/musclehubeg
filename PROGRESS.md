...
> **آخر تحديث:** 2026-09-03 (المرحلة 101: **إعادة بناء لوحة الأدمن — Admin Panel 2.0** — شل أدمن مستقل بقائمة جانبية متداخلة (الرئيسية / الأعضاء / المدربون / المالية / المحتوى / النمو)، جدول أعضاء بحالات اشتراك حقيقية (نشط / ينتهي قريباً / منتهي / بانتظار الدفع) لأول مرة، وصفحة مالية بتفصل فلوس الموقع (اشتراكات العملاء B2C) عن فلوس المدربين (محافظ ورسوم B2B) — بدون أي تغيير في قاعدة البيانات، وكل الروابط القديمة شغالة)
