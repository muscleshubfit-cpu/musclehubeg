...
> **آخر تحديث:** 2026-09-02 (المرحلة 100: **قفل سجل التبديلات** — RLS صارم على plan_swaps، سجل الاستخدام المضاد للعبث اللي بيعتمد عليه نظام استرجاع الفلوس: كل مستخدم يشوف ويسجل تبديلاته هو بس، الكوتش يقرأ فقط تبديلات عملائه المسندين، وممنوع التعديل أو الحذف لأي أحد للأبد لأنه سجل تاريخي — نفس نمط حماية الصور في المرحلة 99)
