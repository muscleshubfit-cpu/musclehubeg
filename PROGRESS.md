...
> **آخر تحديث:** 2026-09-03 (المرحلة 102: **مسح الحساب التجريبي للأدمن** — سكريبت يدوي 0066 يمسح admin.test@musclehub-test.com بالكامل (اتعمل في 0050 للاختبار) من auth.users وprofiles وكل الجداول اللي مالهاش علاقات FK في الإنتاج + lead المزامنة بالإيميل — محلول من مرآة types.ts مش من التخمين، وبدون أي تغيير مخطط)
