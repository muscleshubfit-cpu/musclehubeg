...
| # | الخطوة | الأولوية | الوقت المتوقع |
|---|---|---|---|
| 1 | إصلاح B1 (profile page tier) | 🔴 عالية | 10 دقائق |
| 2 | إصلاح B2 (branding consistency) | 🔴 عالية | 20 دقيقة |
| 3 | إصلاح B3 (start script) | 🔴 عالية | 2 دقائق |
| 4 | تطبيق migration 0011 على الإنتاج | 🔴 عالية | 5 دقائق |
| 5 | إزالة `@ts-nocheck` + إصلاح الأنواع | 🟡 متوسطة | 2 ساعة |
| 6 | تحديث `supabase/types.ts` | 🟡 متوسطة | 30 دقيقة |
| 7 | حذف الـ legacy routes/pages | 🟢 منخفضة | 15 دقيقة |
| 8 | توثيق الـ API endpoints | 🟢 منخفضة | 1 ساعة |
| 9 | إضافة unit tests أساسية | 🟢 منخفضة | 3 ساعات |
