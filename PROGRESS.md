...
> **آخر تحديث:** 2026-09-03 (المرحلة 103: **توحيد عملاء الأدمن + تفرقة المدربين** — صفحة عملاء واحدة تشمل الجميع بأزرار تصفية النوع + قائمة مدربين حقيقية بتفرقة موقع/B2B + قائمة تعيينات B2C جديدة + شبكة أزرار موبايل + إخفاء حدود العضوية عن الأدمن + إزالة روابط الداشبورد القديم — مايجريشن تلقائي واحد 0067 بدون أي سكريبت يدوي)
