...
> **آخر تحديث:** 2026-08-18 (إصلاحات تجربة المستخدم — صور + تخطيط + عضويات)
> **الحالة:** 🔧 جاري إصلاح مشاكل تجربة المستخدم — 7 مُصلحة + 7 متبقية
...
> - ✅ فصل الكوتشينج عن Pro: Coaching يشمل EVO (مستوى Premium) لكن لا يشمل premiumContent
> - ✅ إزالة كلمة "قديم" من أسماء الـ tiers
> - ✅ تصحيح أولوية الـ tier: Pro > Coaching > Premium > Free (حسب المميزات مش السعر)
>
> ### إصلاحات UX المتبقية
> - ⏳ إضافة صور التمارين في تحميل PDF للخطط
> - ⏳ إظهار كل الاشتراكات في الداشبورد (مش واحداً فقط)
> - ⏳ تحسين تصميم توليد الخطط (AI prompts)
> - ⏳ ربط البحث عن الأطعمة في تحرير خطط التغذية
> - ⏳ نظام إشعارات الكوتش (للكل + فردي)
> - ⏳ تنبيه إكمال الاستبيان للعملاء
>
