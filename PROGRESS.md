...
> **آخر تحديث:** 2026-08-19 (إصلاح الاستبيان + إشعار تذكير التقدم الأسبوعي + إصلاح Vercel deploy)
...
| 49 | الاستبيانات (تغذية + لياقة) + إصلاح التنقل | ✅ مكتمل |
...
> - ✅ إعادة هيكلة نظام الإشعارات: استخراج `NotificationForm` مكون مشترك + `notification-templates.ts` قوالب موحدة — تم
  - ✅ إصلاح أزرار الاستبيان: التنقل بين الخطوات يظهر دائماً (التالي/رجوع/مراجعة) حتى لو الاستبيان تم إرساله — تم
  - ✅ إصلاح التحميل المستمر عند إرسال الاستبيان: إضافة validation قبل الإرسال + toast للـ errors — تم
