...
> **آخر تحديث:** 2026-09-02 (المرحلة 81: **قانون الحدود الجديد لتوليد الخطط** — ١+١ أسبوعيًا بإجمالي ٤+٤ شهريًا بدل ٣+٣ شهريًا، وإلغاء سقف المدرب القديم 4/4 المتعارض، + تدقيق نظام المدربين b2b/b2c وتأكيد إتمام كل المهام المؤجلة)
...
- **Blog CMS**: كامل (قائمة + محرر) + cron pipeline (P0 → P5 موزّع يومياً 21:00 UTC + ورك فلو لكل لغة) + manual coach generation + cleanup endpoint
