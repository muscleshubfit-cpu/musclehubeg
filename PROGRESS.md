...
> **آخر تحديث:** 2026-09-02 (المرحلة 85: **توثيق وتدفق المدونة + أداء الهيرو** — الرقم الصريح «6 مقالات/يوم» في كل ملفات التوثيق، تصحيح وصف التدفق الآلي القديم step1-3 → p0-p5، وإضافة sizes لصور الهيرو/EVO في صفحة الهبوط)
