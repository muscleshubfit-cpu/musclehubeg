...
> **آخر تحديث:** 2026-09-02 (المرحلة 98: **تحسين الصور والسرعة خارج فيرسل** — ضغط الصور داخل جهاز المستخدم قبل الرفع (الأفاتار/التقدم/الاستبيانات/صفحات المدربين) بحيث ملفات الموبايل من 3-8 ميجا تنزل لحوالي 200-400 كيلو WebP قبل ما تتخزن، + إعادة ضغط أصول الموقع المحلية (اللوجو 774K → 245K) + preconnect لمصادر صور المدونة — صفر تكلفة وصفر حصص وحل دائم، وبديل Cloudinary جاهز للتركيب لما المالك يبعت اسم الحساب المجاني)
