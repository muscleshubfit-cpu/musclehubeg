...
> **آخر تحديث:** 2026-09-02 (المرحلة 99: **تحسينات المرحلة الثانية** — فهارس المسارات الساخنة ×3 للجداول اللي كانت بلا فهارس، فرض حماية RLS صارمة على صور التقدم (كل مستخدم يشوف صوره هو بس + الكوتش يقرأ صور عملائه)، إصلاح باج حقيقي: دومين بحث المنتجات الخارجي كان ميت بصمت من commit قديم، وOptimistic UI لتبديل الوجبات والتمارين — العداد ينقص فورًا وشارة «جاري التبديل» تظهر لحظة الضغط)
