...
> **آخر تحديث:** 2026-09-02 (المرحلة 97: **حرس حصة الصور المجانية في Vercel** — `images.unoptimized: true` في next.config.ts بتوجيه من المالك: آلاف صور المقالات كانت هتستنفد حصة التحسين المجانية فورًا وتعطّل كل صور الموقع — الصور دلوقتي بتقدم مباشرة من مصادرها وسياسة التحسين محمولة على CDN المصدر، وإعادة تفعيل التحسين المدفوع لاحقًا = سطر واحد)
