...
| Owner action | ⏳ | none — push unblocks the pipeline automatically (0064 v2 → 0065 → 0067 in one deployment); post-push live probes verify coach_kind/site_coach_assignments/RPC appear |
| 0066 v2 (manual, parallel) | ℹ️ | unrelated to this pipeline — still waiting for the owner's SQL Editor run (same raw link) |
