...
> **Current source of truth:** `PROGRESS.md` (root) is now the clean status board. This archive is read-only reference — do NOT update it; new task records go in the new `PROGRESS.md`.
